...
- **Run test server**: `npm run start:a11y`. This offers a proper HTML structure to test.
- **Run accessibility test** : `npm run test:a11y`. This will check the webpage for errors.
